...
Usage:
  pbaf_runSim_litt.jl [--threshold=<alpha>] [--population=<N>] [--generations=<L>] [--rate=<P>] [--monitor=<step>] [--output=<file>]
  pbaf_runSim_litt.jl -h | --help
  pbaf_runSim_litt.jl --version
