...
Usage:
  bafpbaf_runSim_simi.jl [--threshold=<alpha>] [--population=<N>] [--generations=<L>] [--rate=<P>] [--monitor=<step>] [--output=<file>]
  bafpbaf_runSim_simi.jl -h | --help
  bafpbaf_runSim_simi.jl --version
