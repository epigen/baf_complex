...
doc = """Run genetic algorithm on shuffled BAF complex structure.

Usage:
  shuffle_runSim_litt.jl [--threshold=<alpha>] [--population=<N>] [--generations=<L>] [--rate=<P>] [--monitor=<step>] [--output=<file>]
  shuffle_runSim_litt.jl -h | --help
  shuffle_runSim_litt.jl --version
